        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            requiredFields.forEach(function(field) {
                ...
                if (!value) {
                    ...
                    formData[field.getAttribute('name') || field.id] = value;
                }
            ...
            if (isValid) {
                ...
                // Reset form after successful validation (optional)
                // contactForm.reset();
            }
        });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'cb98c440-92d9-4431-91d6-c00716c251e4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'cb98c440-92d9-4431-91d6-c00716c251e4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'cb98c440-92d9-4431-91d6-c00716c251e4';
